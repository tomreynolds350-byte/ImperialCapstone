...
- `directives/stage2_overview.md`
    - High-level Stage 2 rules, workflow, constraints, and reflections.
- `directives/function_descriptions.md`
    - Official function descriptions, dimensions, and initial sample sizes.
...
| 1.0.1 | January 28, 2026 | Added Stage 2 overview and function descriptions directives |
