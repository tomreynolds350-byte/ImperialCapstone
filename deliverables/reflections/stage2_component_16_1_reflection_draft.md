...
- Loss: optimise not only predicted value, but a composite objective (value + uncertainty + novelty).
...
This helped me treat the capstone as an iterative learning system rather than a one-shot optimiser.
